...
| ---- | ---- | ----------- | -------- |
| HCL DevOps Test Hub URL | textBox | The URL of your HCL DevOps Test Hub. | Yes |
| Offline Token | secureBox | HCL DevOps Test Hub Offline Token | Yes |
...
| File Path | textBox | Path to the HCL DevOps Test Hub test file. | Yes |
...
| Custom Trust Store Path | textBox | Path to the custom trust store including the file name. This trust store must include the certificate of the CA that issued the SSL certificate of your HCL DevOps Test Hub instance or the SSL certificate of your HCL DevOps Test Hub instance. This field cannot be left blank when the SSL certificate of your HCL DevOps Test Hub instance is signed by an internal CA or when you're unable to establish secure connection to your HCL DevOps Test Hub instance. Otherwise it can be left blank. | No |
...
| HTTP Proxy Host | textBox | Provide the hostname of the HTTP proxy to use to connect to HCL DevOps Test Hub. Eg proxy.domain.com | No |
| HTTP Proxy Port | textBox | Provide the port number of the HTTP proxy to use to connect to HCL DevOps Test Hub. | No |
