...
* [Run an DevOps Test Performance test](#run_an_devops_test_performance_test)
## Run an DevOps Test Performance test

Run test using DevOps Test Performance
...
| Publish | textBox | Optional. You can use this option to publish test results to IBM DevOps Test Hub. The format is: serverURL#project.name=projectName&teamspace.name=teamspaceName. Example: `https://localhost:5443/#project.name=test&teamspace.name=ts1` | Yes |
...
| Publishreports | textBox | Optional. You can use this option to specify the reports to be published to IBM DevOps Test Hub. The supported values are STATS,TESTLOG. | Yes |
