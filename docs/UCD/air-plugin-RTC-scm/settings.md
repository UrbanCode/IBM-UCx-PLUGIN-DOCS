...
| Version Naming Convention | Enumeration: ID, NAME | Use the ID or Name for the Versions Name when Importing Versions Automatically, Importing Stream, or when Import Versions name is left blank. |
...
| Name | Type | Description |
| --- | --- | --- |
| Workspace History | Enumeration: SNAPSHOT, STREAM | Use a snapshot or stream as the initial workspace history. |
